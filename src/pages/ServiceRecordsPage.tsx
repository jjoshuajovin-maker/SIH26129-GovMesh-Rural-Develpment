              ...
              {filteredRecords.length === 0 ? (
                <tr>
                  <td colSpan={8} className="p-8 text-center text-slate-500 font-sans text-xs">
                    No citizen applications received yet. Real applications submitted via GovMesh to <code className="bg-slate-100 px-1 py-0.5 rounded text-gov-blue">/api/rural/address-update</code> will appear here automatically.
                  </td>
                </tr>
              ) : (
                          ...
                          <div className="flex items-center justify-end space-x-1">
                            ...
                            <button
                              onClick={async () => {
                                ...
                                if (reason) {
                                  await fetch(`/api/rural/application/${rec.applicationId}/reject`, {
                                    method: 'POST',
                              ...
                              className="bg-red-600 hover:bg-red-700 text-white font-bold text-[10px] px-2 py-1 rounded"
                            >
                              Reject
                            </button>
                          </div>
                        )}
                        {(st === 'APPROVED' || st === 'COMPLETED' || st === 'REJECTED') && (
